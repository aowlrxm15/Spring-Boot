...
public class MainController {
	...
	public String query4() {
		User1VO user = repo.findUser1VOByUidAndName("A104", "강감찬");
	...
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("A104", "장보고");
	...
	public String query6() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThan(66);
	...
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(65);
	...
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(66);
	...
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(19);
	...
	public String query10() {
		List<User1VO> users = repo.findUser1VOByNameLike("장보고");
	...
	public String query11() {
		List<User1VO> users = repo.findUser1VOByNameContains("장보고");
	...
	public String query12() {
		List<User1VO> users = repo.findUser1VOByNameStartsWith("장보고");
	...
	public String query13() {
		List<User1VO> users = repo.findUser1VOByNameEndsWith("장보고");
	...
	public String query17() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanOrderByAgeDesc(11);
	...
	public String query18() {
		int users = repo.countUser1VOByUid("A104");
	...
	public String query19() {
		int users = repo.countUser1VOByName("강감찬");
	...
	public String query22() {
		List<User1VO> users = repo.selectUserByNameWithParam("이순신");
